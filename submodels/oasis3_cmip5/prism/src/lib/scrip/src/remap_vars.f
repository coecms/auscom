...
!-----------------------------------------------------------------------
!
!     CVS:$Id: remap_vars.f,v 1.1.1.1 2003/07/29 17:20:11 valcke Exp $
!
...
!-----------------------------------------------------------------------
     ...
     &            wts_tmp(num_wts,mxlinks),stat=ierr)
        if (ierr .ne. 0) then
!bi003          print *,'error allocating temps in resize: ',ierr
          write(101,*)'error allocating temps in resize: ',ierr
          stop
        endif
     ...
     &            wts_map2(num_wts,max_links_map2),stat=ierr)
        if (ierr .ne. 0) then
!bi003          print *,'error allocating new arrays in resize: ',ierr
          write(101,*)'error allocating new arrays in resize: ',ierr
          stop
        endif
