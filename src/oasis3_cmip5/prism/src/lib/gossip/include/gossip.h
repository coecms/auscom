...
#define swap_8(mot) { register unsigned INT_64 tmp1; register unsigned INT_64 tmp2; \
   tmp1 = ((unsigned INT_64) mot << 32) >> 32 ; \
   tmp2 = (unsigned INT_64) mot >> 32 ; \
   mot  = ( (tmp1>>24) | (tmp1<<24) | ((tmp1>>8)&0xFF00) | ((tmp1&0xFF00)<<8) ) << 32 ; \
   mot |= ( (tmp2>>24) | (tmp2<<24) | ((tmp2>>8)&0xFF00) | ((tmp2&0xFF00)<<8) ); }
...
#define MAX_EXTENDED_CLIENTS 256
