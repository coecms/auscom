...
!-----------------------------------------------------------------------
!
!     CVS:$Id: remap_gauswgt.f,v 1.3 2006/07/26 13:04:57 valcke Exp $
!
...
!-----------------------------------------------------------------------
     ...
     &     dist_average    ! average distance between the source points
      ...
      real (kind=dbl_kind) ::
     &        distance ,plat,plon,src_latsnn   ! angular distance
