...
NETCDF = /opt/netcdf/3.6.1/intel-9.0
CPPFLAGS =
FFLAGS_BASE = -V -what -fno-alias -stack_temps -safe_cray_ptr -ftz -i_dynamic -assume byterecl -g -i4 -r8
FFLAGS_REPRO = -fltconsistency
FFLAGS_DEBUG = -check -warn -warn noerrors -debug variable_locations -inline_debug_info -traceback
FFLAGS = $(FFLAGS_BASE) -O2 -fpp -I$(NETCDF)/include
FC = ifort
CC = icc
CFLAGS = -V -g -O2 -w -D__IFC -I$(NETCDF)/include
LD = ifort
#LDFLAGS = -Wl,-V,--verbose,-Map map -lnetcdf -lmpi -lsma
LDFLAGS = -L$(NETCDF)/lib -lnetcdf -lmpi -lsma
